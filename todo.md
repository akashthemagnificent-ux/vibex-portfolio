# Vibex Base Website — Premium Minimal Foundation

- [x] Analyze the supplied Minds reference for composition, typography, motion, pacing, and interaction patterns.
- [x] Translate the inspiration into an original Vibex visual blueprint without copying branding, assets, or copy.
- [x] Confirm the base visual direction and hero choreography with Ash before implementation.
...
- [x] Add the supplied 3D CSS box-loader as a branded full-screen initial loading layer.
...
- [x] Register the user-supplied `frontend-design` guidance as a reusable skill for future portfolio design and UI changes.
- [x] Apply the skill’s subject-led planning, distinctive visual direction, and restrained self-critique process to the next requested portfolio design change.

## Full-Page Molten Metal Redesign

- [x] Extend the Molten Metal WebGL canvas from the hero to a fixed, full-page background layer.
- [x] Increase the shader’s visible material contrast and scale without replacing or reducing the original interaction behavior.
- [x] Preserve readable section content using intentional local contrast surfaces rather than hiding the overall background.
- [x] Verify visible WebGL material and text clarity on desktop and mobile, then run regression validation and save a checkpoint.
- [x] Save a checkpoint containing the completed full-page Molten Metal redesign and its verified visual record.
