    ...
    <main className={`proof-shell ${entryState !== "done" ? "is-loading" : ""}`} aria-busy={entryState !== "done"}>
      ...
      <section className="proof-hero" id="index" data-scene aria-labelledby="proof-title">
        ...
        <div className="proof-hero__copy">
          ...
          <h1 id="proof-title" className="proof-title proof-title--particles" aria-label="People know the name. Almost nobody knows the person."><span className="proof-title--sr">People know the name. Almost nobody knows the person.</span><ParticleText text={'People know\nthe name.\nAlmost nobody\nknows the person.'} particleSize={2} density={4} color="#e7e2d7" highlightColor="#d8c19a" scatter={180} gatherDuration={1600} stagger={420} pointerRepel={40} repelRadius={120} idleDrift={0.7} trigger="mount" fontSize="clamp(3.1rem, 13.5vw, 6.6rem)" fontWeight={500} fontFamily="'PVC Dynasty', 'Eurostile', sans-serif" glow={true} lineHeight={0.86} initiallySettled={true} /></h1>
